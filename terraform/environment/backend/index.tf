...
locals {
  lambdas = [
    "accept/post",
    "application/accept/post",
    "application/reject/post",
    ...
    "office/{id}/delete",
    "office/{id}/put",
    "office/{id}/integration/put",
    "office/{id}/integrations/get",
    "office/{id}/integration/{integration}/delete",
    "office/{id}/rates/get",
    "office/{id}/rates/put",
    "offices/get",
    "offices/reports/get",
    ...
    "vcita/clients/created/post",
    "vcita/clients/updated/post"
  ]
