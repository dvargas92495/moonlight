...
const theme = (process.env.REACT_APP_THEME || 'STRIKING_AND_SIMPLE') as keyof typeof colors;

export const PRIMARY_BACKGROUND_COLOR   = colors[theme].primaryBackgroundColor;
export const SECONDARY_BACKGROUND_COLOR = colors[theme].secondaryBackgroundColor;
